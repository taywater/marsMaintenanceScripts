...
```{r setup, include=FALSE}
  ...
  dbWriteTable(MARSDB_con, DBI::SQL("log.tbl_script_wic"), logMessage, append = TRUE, row.names=FALSE)
...
if(success_wo == TRUE){
    ...
    dbWriteTable(MARSDB_con, DBI::SQL("log.tbl_writes_wic"), logMessage, append = TRUE, row.names=FALSE)
}
