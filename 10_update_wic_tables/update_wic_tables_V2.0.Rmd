...
Number of New WIC Property Lines Geometry: `r colorize(nrow(wic_propertyline_combined_sf),"red")`

Number of New WIC Footprints Geometry: `r colorize(nrow(wic_footprint_combined_sf), "red")`

## 4.2 Add WIC Polygons to MARS DB {.hidden .unlisted}

### 4.2.1 Add Property Lines {.hidden .unlisted}

```{r 4.2.1 Add WIC Property Lines in MARS DB, eval= params$write == TRUE & nrow(wic_propertyline_combined_sf) > 0, include=FALSE}
...
```{r 4.2.2 Add WIC Footprints in MARS DB, eval= params$write == TRUE & nrow(wic_footprint_combined_sf) > 0, include=FALSE}
...
## 5.6 Summary Table of New/Changed WICs near Systems
