...
```{r Section R1: New Files Output, echo = FALSE, include = TRUE, eval = all(keepRunning, nrow(display_filetable) > 0)}
...
```{r Section 2.5, Writing to the baro table, include = TRUE, echo = FALSE, eval = keepRunning}
