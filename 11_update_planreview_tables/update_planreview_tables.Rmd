...
#Write to mars_data
  ...
  #write update query-----
        ...
        expr = {
          update_smp <- dbSendQuery(mars_data, 'update external.planreview_view_smp_designation set ProjectID=?, SMPID=?, Projectname =  ?, TrackingNumber=?, Designation=?, SMIP=?, GARP=?, OOWProgramType=?, hash_md5=? WHERE planreview_view_smp_designation_uid=?')
