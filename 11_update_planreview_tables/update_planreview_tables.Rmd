...
query_test <- nrow(view_smp_designation) > 0
...
#Write to mars_data
  ...
  #write update query-----
        ...
        expr = {
          update_smp <- dbSendQuery(mars_data, 'update external.planreview_view_smp_designation set ProjectID=?, SMPID=?, Projectname =  ?, TrackingNumber=?, Designation=?,  OOWProgramType=?, hash_md5=?, SMIP=?, GARP=? WHERE planreview_view_smp_designation_uid=?')
