...
folder = "C:/Users/taylor.heffernan.wa/Documents/marsMaintenanceScripts/05_update_rainfall_tables"
r_script = "update_rainfall_tables.rmd"
output = paste0("logs/", datestring, "_update_rainfall_tables.html")
