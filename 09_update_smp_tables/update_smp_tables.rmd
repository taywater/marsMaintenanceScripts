...
errorCode = 0
  ...
  dbWriteTable(marsDBCon, DBI::SQL("log.tbl_script_smp"), logMessage, append = TRUE, row.names=FALSE)
...
```{r Break Point 4 - Bad Write, echo = FALSE, eval = kill}
...
# Script Results: `r ifelse(kill, "FAILURE", ifelse(success, "FAILURE", "SUCCESS"))`
