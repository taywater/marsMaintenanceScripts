...
errorCode = 0
  ...
  dbWriteTable(mars, DBI::SQL("log.tbl_script_cipit"), logMessage, append = TRUE, row.names=FALSE)
...
if(!kill){
    ...
    dbWriteTable(marsDBCon, DBI::SQL("log.tbl_writes_cipit"), logMessage, append = TRUE, row.names=FALSE)
}
