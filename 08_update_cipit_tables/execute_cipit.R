...
folder = "C:/Users/taylor.heffernan.wa/Documents/marsMaintenanceScripts/08_update_cipit_tables"
r_script = "update_cipit_tables.rmd"
output = paste0("logs/", datestring, "_update_cipit_tables.html")
