...
folder = "//pwdoows/oows/Watershed Sciences/GSI Monitoring/07 Databases and Tracking Spreadsheets/13 MARS Analysis Database/PG14/PG14 Maintenance Scripts/Scripts/Update Baro Tables"
r_script = "update_baro_tables.rmd"
