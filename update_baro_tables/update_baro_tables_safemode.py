...
r_script = "'A:\\\\Scripts\\\\Maintenance\\\\update_baro_tables\\\\update_baro_tables.rmd'"
...
outputexists = os.path.isfile('A:\\Scripts\\Maintenance\\update_baro_tables\\' + output_file.strip("'"))
if outputexists:
    webbrowser.open(os.path.realpath('A:\\Scripts\\Maintenance\\update_baro_tables\\' + output_file.strip("'")))
else:
    webbrowser.open(os.path.realpath("A:\\Scripts\\Maintenance\\update_baro_tables\\baro_error.html"))
