...
```{r Section 1B - Writing to the tbl_ow_leveldata_raw table, eval = nrow(display_newdata) > 0}	
  ...
  for(i in 1:nrow(owdata_results)){
    ...
    dbGetQuery(marsDBCon, "refresh materialized view data.mat_level_data_quarter;")
```
...
```{r Section 2B - Writing to the tbl_gw_depthdata table, eval = nrow(display_newdata) > 0}	
  ...
  for(i in 1:nrow(gwdata_results)){
    ...
    #Refresh matview for QA Shiny app
    dbGetQuery(marsDBCon, "refresh materialized view data.mat_gw_data_quarter;")
