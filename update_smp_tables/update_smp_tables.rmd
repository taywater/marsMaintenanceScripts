...
dsn_infra_pub <- paste0("{ODBC Driver 17 for SQL Server}:server=pwdgissql;",
...
```{r Section 3.5 - Writing to the smp_radar table, echo = FALSE, eval = all(keepRunning, nrow(smp_loc_noradar) > 0)}
    knitr::asis_output(paste0("### New radar associations in `admin.tbl_smp_radar`: ",  nrow(smp_loc_nogage)))
