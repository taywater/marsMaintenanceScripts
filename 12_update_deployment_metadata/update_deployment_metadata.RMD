...
###Section 0.2: Connect to the database
  ...
  dbWriteTable(marsDBCon, DBI::SQL("log.tbl_script_deploymentmetadata"), logMessage, append = TRUE, row.names=FALSE)
    ...
    tryCatch(
      ...
      expr = {
        dbWriteTable(marsDBCon, 
          DBI::SQL("fieldwork.tbl_deployment_con_status"), 
...
if(!kill){
    ...
    dbWriteTable(marsDBCon, DBI::SQL("log.tbl_writes_deploymentmetadata"), logMessage, append = TRUE, row.names=FALSE)
}
```
